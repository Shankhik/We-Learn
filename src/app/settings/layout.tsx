    ...
    const mainLayout = (
        ...
        >
            ...
            <div style={{display:'flex', justifyContent:'center', marginBottom:'20px'}}>
                <div className='theme-btn' onClick={()=>{setTheme('light')}}
                    style={{
                        width:"38px", height:'38px',
                        boxShadow: `0 0 5px rgba(0, 0, 0, ${effectiveTheme==='light'?0.3:0}`,
                        background: effectiveTheme==='dark'?'rgb(80, 80, 80)':''
                    }}>
                ...
                <div className='theme-btn' onClick={()=>{setTheme('default')}} 
                    style={{
                        width:'38px', height:'38px',
                        boxShadow: `0 0 5px rgba(0, 0, 0, ${effectiveTheme==='light'?0.3:0}`,
                        background: effectiveTheme==='dark'?'rgb(80, 80, 80)':''
                ...
                <div className='theme-btn' onClick={()=> {setTheme('dark')}} 
                    style={{
                        width:'38px', height:'38px',
                        boxShadow: `0 0 5px rgba(0, 0, 0, ${effectiveTheme==='light'?0.3:0}`,
                        background: effectiveTheme==='dark'?'rgb(80, 80, 80)':''
