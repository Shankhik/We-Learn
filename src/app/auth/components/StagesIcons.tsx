...
type StagesIconsProps = {
    width?: `${number}px`|number,
    height?: `${number}px`|number,
    fill?: string,
    type: "user"|"password"|"email"|"document"|"ok"
    
    style?: React.CSSProperties,
    className?: string
    
}
export default function StagesIcons({
    width, height, fill, type, ...props
}:StagesIconsProps){
    ...
    {/* Password */}
    <g style={{
        display: type==="password"?"inline":"none",
        fill: "none", strokeWidth: 2,
        stroke: fill||defaultFill,
    }}>
        <path
        d="m14.986 20.426-3.77 6.528m0-6.528 3.77 6.528M9.332 23.69h7.538"
        transform="matrix(.88077 0 0 .88077 2.892 9.712)"
      />
      <path
        d="m14.986 20.426-3.77 6.528m0-6.528 3.77 6.528M9.332 23.69h7.538"
        transform="matrix(.88077 0 0 .88077 13.46 9.712)"
      />
      <path
        d="m14.986 20.426-3.77 6.528m0-6.528 3.77 6.528M9.332 23.69h7.538"
        transform="matrix(.88077 0 0 .88077 24.03 9.712)"
      />
      <path
        d="M19.515 22.702h10.778m10.697-.001a2.247 2.247 0 0 1 2.252 2.252v10.922a2.247 2.247 0 0 1-2.252 2.251H9.01a2.247 2.247 0 0 1-2.252-2.251V24.953A2.247 2.247 0 0 1 9.01 22.7h6.95s-.712-10.71 9.166-10.826c9.877-.117 9.076 10.827 9.076 10.827z"
      />
    </g>
    {/* Email */}
    ...
    <g style={{ display: type==="document"? "inline" : "none" }}>
        <rect
            width={29.78}
            height={35.025}
            x={10.11}
