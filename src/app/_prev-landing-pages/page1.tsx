...
import moduleStyle from "./page1.module.css";
...
export default function LandingPage (){
    ...
    <div className={
        ...
        >
            <div className={moduleStyle['fade']}/>
            ...
            <Image src={HeroSectionDoodle} alt={"Doodle"}
                className={moduleStyle['doodle']}
                loading={'eager'}
            />
        </div>
        <Main/>
    ...
    <nav className={moduleStyle['navbar']}>
        ...
        <HideIf hideIf={!verified}>
            <NavbarButton
                ...
                href={"/home"} isScrolled={isScrolled}
...
const Footer = ({effectiveTheme, ref}:FooterProps)=>{
