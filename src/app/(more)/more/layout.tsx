...
export default function Layout ({children}: Readonly<{children: React.ReactNode}>){
    ...
    const dropIcon = (
        <svg id='more-drop-icon' className={showDropLinks?'enabled':'disabled'} width="16" height="16" viewBox="0 0 16 16" fill="rgb(71, 91, 156)" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className='more-page'>
            <div className='more-page-navbar'>
                <div>
                    <img src='https://res.cloudinary.com/dwjtsqbqn/image/upload/v1739002192/WeLearn/full-logo.png' alt='e'/>
