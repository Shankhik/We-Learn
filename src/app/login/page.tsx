...
export default function LoginPage() {
    ...
    const [alertHeading, setAlertHeading] = useState<string>(`Couldn't Login !`);
    ...
    const submitForm = async(e: FormEvent)=>{
        ...
        const response:status = await post(ApiLinks.loginReq.this,formData)
    ...
    <div className="login-page">
        ...
        <Alert show={showAlert} close={setShowAlert}>
            <div className='login alert-box'>
                ...
                <p className='login alert-box-message'>{alertMessage}</p>
                <button className='login alert-box-close' onClick={()=>setShowAlert(false)}>CLOSE</button>
            </div>
        </Alert>
