...
import moduleStyle from "./ShowHidePwd.module.css"
...
const ShowPassword = React.memo(({
    ...
    //const [show, setShow] = useState<boolean>(initiallyShown?true:false)
    const main = ref || useRef<HTMLDivElement>(null)
    return (
    <div
        {...props}
        style={{
